// Funções de formatação (parseCSV, formatarTelefone, etc.)
...
document.addEventListener('DOMContentLoaded', () => {
    // Lógica do menu dropdown e botão limpar
        ...
        async function carregarTudo() {
            ...
            try {
                ...
                codigosDaLoja.forEach(codigo => {
                    ...
                    if (produto) {
                        // ==================================================================
                        // ✅ AQUI ESTÁ A CORREÇÃO PARA O LAYOUT! ✅
                        // Removemos o "div" extra com a classe "produto-info" e organizamos
                        // todos os campos como filhos diretos do "produto-card".
                        // Agora a estrutura bate com o "cabecalho-tabela" do seu HTML.
                        // ==================================================================
                        const cardHTML = `
                            <div class="produto-card" data-codigo="${produto.codigo}" data-original="true">
                                <div class="produto-imagem"><img src="${produto.imagem_url}" alt="${produto.nome}" onerror="this.style.display='none'"></div>
                                <div class="produto-nome">${produto.nome}</div>
                                <div class="produto-preco">R$ ${parseFloat(produto.preco_unitario).toFixed(2)}</div>
                                <div class="produto-quantidade"><input type="number" min="0" step="any" placeholder="0"></div>
                                <div class="produto-unidade">${produto.unidade}</div>
                                <div class="produto-validade-acoes">
